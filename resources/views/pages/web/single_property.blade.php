        ...
        <div class="row">
            <div class="col-lg-8 col-md-12 blog-pots">
                    ...
                    <div class="col-md-12">
                            ...
                            <div class="pro-wrapper">
                                <div class="detail-wrapper-body">
                                    <div class="listing-title-bar">
                                        <h3>{{ $peoperty_detail->property_title }} <span class="mrg-l-5 category-tag">For {{ getPostType($peoperty_detail->property_status) }}</span></h3>
                                        <div class="mt-0">
                                            <a href="#listing-location" class="listing-address">
                                                <i class="fa fa-map-marker pr-2 ti-location-pin mrg-r-5"></i>{{ $peoperty_detail->property_address }}
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="single detail-wrapper mr-2">
                                    <div class="detail-wrapper-body">
                                        <div class="listing-title-bar">
                                            <h4>PKR {{ number_format($peoperty_detail->property_price,2) }}</h4>
                                            <div class="mt-0">
                                                <a href="#listing-location" class="listing-address">
                                                    <p>{{ $peoperty_detail->property_area }} / sq ft</p>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div id="listingDetailsSlider" class="carousel listing-details-sliders slide mb-30">
                            ...
                            <div class="carousel-inner">
                                @php $i = 0; @endphp
                                @foreach(getPropertyMedia($peoperty_detail->property_id,"image") as $image)
                                    <div class="active item carousel-item" data-slide-number="{{ $i }}">
                                        <img src="{{ Storage::url($image) }}" class="img-fluid" alt="Plot Mandi - Property Image">
                                    </div>
                                    @php $i++; @endphp
                                @endforeach
                                ...
                                @foreach(getPropertyMedia($peoperty_detail->property_id,"image") as $image)
                                    <li class="list-inline-item {{ $i == 0 ? "active" : "" }}">
                                        <a id="carousel-selector-{{ $i }}" class="selected" data-slide-to="{{ $i }}" data-target="#listingDetailsSlider">
                                            <img src="{{ Storage::url($image) }}" class="img-fluid" alt="listing-small">
                                        </a>
                                    </li>
                                    @php $i++; @endphp
                                @endforeach
                        ...
                        <div class="blog-info details mb-30">
                            ...
                            <p class="mb-3">
                                {{ $peoperty_detail->property_description }}
                            </p>
                        </div>
                    </div>
                </div>
                <div class="single homes-content details mb-30">
                    ...
                    <ul class="homes-list clearfix">
                        <li>
                            ...
                            <span class="det">PM-00{{ $peoperty_detail->property_id }}</span>
                        </li>
                        <li>
                            <span class="font-weight-bold mr-1">Property Type:</span>
                            <span class="det">{{ getPropertyType($peoperty_detail->property_type) }}</span>
                        </li>
                        <li>
                            <span class="font-weight-bold mr-1">Property status:</span>
                            <span class="det">For {{ getPostType($peoperty_detail->property_status) }}</span>
                        </li>
                        <li>
                            <span class="font-weight-bold mr-1">Property Price:</span>
                            <span class="det">RS {{ number_format($peoperty_detail->property_price,2) }} </span>
                        </li>
                        <li>
                            <span class="font-weight-bold mr-1">Rooms:</span>
                            <span class="det">{{ $peoperty_detail->property_rooms }}</span>
                        </li>
                        <li>
                            <span class="font-weight-bold mr-1">Kitchens:</span>
                            <span class="det">{{ $peoperty_detail->property_kitchens }}</span>
                        </li>
                        <li>
                            <span class="font-weight-bold mr-1">Bath:</span>
                            <span class="det">{{ $peoperty_detail->property_bathrooms }}</span>
                        </li>
                        <li>
                            <span class="font-weight-bold mr-1">Registration On Plot Mandi:</span>
                            <span class="det">{{ PlotDateFormater($peoperty_detail->created_at, "Y-m-d") }}</span>
                        </li>
                    </ul>
                    <!-- title -->
                    ...
                    <!-- cars List -->
                    <ul class="homes-list clearfix">
                        @foreach(json_decode($peoperty_detail->property_features) as $feature)
                        <li>
                            <i class="fa fa-check-square" aria-hidden="true"></i>
                            <span>{{ getPropertyFeatures($feature) }}</span>
                        </li>
                        @endforeach
                    </ul>
                </div>
                ...
                <div class="property wprt-image-video w50 pro">
                    ...
                    @foreach(getPropertyMedia($peoperty_detail->property_id,"video") as $video)
                        <img alt="image" src="images/slider/home-slider-4.jpg">
                        <a class="icon-wrap popup-video popup-youtube" href="{{ Storage::url($video) }}">
                ...
                <div class="single widget">
                    ...
                    <div class="schedule widget-boxed mt-33 mt-0">
                        <div class="widget-boxed-header">
                            <h4><i class="fa fa-calendar pr-3 padd-r-10"></i>Biding</h4>
                        </div>
