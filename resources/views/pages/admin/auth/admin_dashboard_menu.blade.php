...
<div class="col-md-3 col-lg-3 user-dash-sidebar">
    <nav class="sidebar locked">
        ...
        <div class="menu_container" >
                ...
                <div class="menu_items" style="position: relative;top: -10%;">
                <ul class="menu_item">
            ...
            <div class="sidebar_profile flex">
                ...
                <div class="data_text">
                    <a class="name" href="{{ route('admin_logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Log Out</a>
