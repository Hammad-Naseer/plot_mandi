                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a href="{{ route('edit_offer', base64_encode($list->offer_id)) }}" class="btn btn-success text-white"><i class="far fa-edit"></i></a>
                                        <a onclick="return confirm('Are you sure you want to delete this record?')" href="{{ route('delete_offer', base64_encode($list->offer_id)) }}" class="btn btn-danger text-white"><i class="far fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
