                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{ getPostType($list->type) }}</td>
                                    ...
                                    <td class="text-right">
                                        <a href="{{ route('edit_post', base64_encode($list->post_id)) }}" class="btn btn-success text-white"><i class="far fa-edit"></i></a>
                                        <a onclick="return confirm('Are you sure you want to delete this record?')" href="{{ route('delete_plot_pedia', base64_encode($list->post_id)) }}" class="btn btn-danger text-white"><i class="far fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
